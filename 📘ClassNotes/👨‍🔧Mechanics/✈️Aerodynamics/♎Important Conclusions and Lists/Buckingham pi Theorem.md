Let $K$ equal the number of fundamental dimensionless required to describe the physical variables (mass $m$, length $l$, time $t$.) (hence in mechanics the dimension of the problem is $K=3$)
