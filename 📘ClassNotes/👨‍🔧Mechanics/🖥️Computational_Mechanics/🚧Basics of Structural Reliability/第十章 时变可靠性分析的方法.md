...
参考[[📘ClassNotes/👨‍🔧Mechanics/🖥️Computational_Mechanics/🚧Basics of Structural Reliability/推导部分/跨越率方法有关定理推导过程.pdf|跨越率方法有关定理推导过程.pdf]], 有不等式:
...
我们假设跨越次数服从[[📘ClassNotes/📐Mathmatics/🎣Probability Theory/第二章 随机变量及其分布#3. 泊松分布|泊松分布]], 参考[[📘ClassNotes/👨‍🔧Mechanics/🖥️Computational_Mechanics/🚧Basics of Structural Reliability/推导部分/跨越率方法有关定理推导过程.pdf|跨越率方法有关定理推导过程.pdf]], 时变失效概率的计算表达式可以计算为:
