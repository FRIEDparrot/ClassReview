...
> 其中MCMC方法参考[[📘ClassNotes/👨‍🔧Mechanics/🖥️Computational_Mechanics/🚧Basics of Structural Reliability/推导部分/马尔科夫链样本模拟求解设计点.pdf|马尔科夫链样本模拟求解设计点.pdf]] 
...
根据[[📘ClassNotes/👨‍🔧Mechanics/🖥️Computational_Mechanics/🚧Basics of Structural Reliability/推导部分/多失效模式线抽样方法修正公式推导.pdf|多失效模式线抽样方法修正公式推导.pdf]]部分可得**修正公式**:
...
### (3) 正态相关变量情况下的变量转换方法
考虑n维相关正态输入变量$X = [X_{1}, \dots X_{n}]^{T}$, 此时$X$的联合密度函数，可以参考[[📘ClassNotes/👨‍🔧Mechanics/🖥️Computational_Mechanics/🚧Basics of Structural Reliability/第二章 蒙特卡洛模拟方法#四、正态相关变量下的可靠新余可靠性局部灵敏度的计算方法|第二章 蒙特卡洛模拟方法]]部分, 联合密度概率函数为:
...
上述变换将 X 变换为 Y， 参考[[📘ClassNotes/👨‍🔧Mechanics/🖥️Computational_Mechanics/🚧Basics of Structural Reliability/第二章 蒙特卡洛模拟方法#(1) 正态变量的独立转换|正态变量的独立转换]]和[[📘ClassNotes/👨‍🔧Mechanics/🖥️Computational_Mechanics/🚧Basics of Structural Reliability/推导部分/相关变量下转换为独立变量的公式推导.pdf|相关变量下转换为独立变量的公式推导.pdf]], 有<b><mark style="background: transparent; color: blue">转换后的均值和方差关系</mark></b>:
