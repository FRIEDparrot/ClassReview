...
往往先通过共轭梯度法， 最速下降法或者[[📘ClassNotes/⌨️Programming/👨‍🎓Deep Learning/🌟常用优化算法合集/2. 遗传优化算法(GA)|遗传算法]]，[[📘ClassNotes/⌨️Programming/👨‍🎓Deep Learning/🌟常用优化算法合集/1. 模拟退火算法(SA)|模拟退火算法]]等等求解**时域上的最小值**;只需通过求解极小值点和取其中最小的点获取即可。
