...
通过[[📘ClassNotes/👨‍🔧Mechanics/🚲Mechanics of materials/第三章 剪切, 挤压#(3) 剪切应变能|剪切应变能的计算]]也可以进行弹性常数关系式的推导 
[[📘ClassNotes/👨‍🔧Mechanics/🚲Mechanics of materials/补充内容/使用形状改变比能推导弹性常数关系式.pdf|使用形状改变比能推导弹性常数关系式.pdf]]
