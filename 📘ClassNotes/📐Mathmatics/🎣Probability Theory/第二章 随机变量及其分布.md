...
称$X$服从参数为$\lambda$的<mark style="background: transparent; color: red">泊松分布</mark>, 分布表可查[[📘ClassNotes/📐Mathmatics/🎣Probability Theory/补充部分/重要分布表整理#泊松分布表|泊松分布表]], 记为$X \sim \pi(\lambda)$, 显然有:
