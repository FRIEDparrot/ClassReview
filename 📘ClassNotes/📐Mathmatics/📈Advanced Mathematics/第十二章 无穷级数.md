...
定理2 (<mark style="background: transparent; color: red">收敛半径的计算</mark>)若对于幂级数$\sum^{\infty}_{n=0} a_n x_n$
...
对于收敛性的判定，其<mark style="background: transparent; color: red">性质在两区间的较小区间内成立</mark>
除法可以使用待定系数来进行，即
