...
证明见[[📘ClassNotes/📐Mathmatics/ℹ️Complex Variables/补充内容/幅角原理及对数留数例题.pdf|幅角原理及对数留数例题.pdf]]
`````ad-cite 
title: 说明
collapse: open
...
`````
### (3) 路西定理
Rouche定理用于对两个函数的零点个数进行比较, 并在[[📘ClassNotes/📐Mathmatics/ℹ️Complex Variables/补充内容/幅角原理及对数留数例题.pdf|幅角原理及对数留数例题.pdf]]中给出证明。
