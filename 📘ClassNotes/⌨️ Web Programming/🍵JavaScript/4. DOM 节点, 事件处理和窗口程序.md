...
其中，对于前进和后退选项的实现, 需要用到 [history](https://www.w3schools.com/jsref/prop_win_history.asp) 的方法。主要是如下两个(参考[[📘ClassNotes/⌨️ Web Programming/🍵JavaScript/3. JavaScript 语法入门和对象#(5) JS 预定义对象|3. JavaScript 语法入门]])
