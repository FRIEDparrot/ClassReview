## 一、二叉树的基本概念
### 1. 树的基本知识和遍历方法
[[📘ClassNotes/⌨️Programming/🌳C (Data Structure & Algorithms)/C++基础知识/复习 树的基本知识|树的基本知识复习和基本的功能实现]]
...
对于二叉树的定义，往往使用二叉链表的结构，可以参考[[📘ClassNotes/⌨️Programming/🌳C (Data Structure & Algorithms)/C++基础知识/复习 树的基本知识#二、二叉树及其基本性质|二叉树的定义以及遍历方法]]
...
### (3) 哈夫曼编码
哈夫曼编码是对于给定的带权路径求解规模最小的问题, 证明参考[[📘ClassNotes/⌨️Programming/🌳C (Data Structure & Algorithms)/🛰️Algorithms/第四章 贪心算法|第四章 贪心算法]] 
1. 哈夫曼编码的概念
...
## 八、堆存储的概念
参考：[[📘ClassNotes/⌨️Programming/🌳C (Data Structure & Algorithms)/C++基础知识/复习 七大排序算法#四、堆排序算法|堆排序]]
