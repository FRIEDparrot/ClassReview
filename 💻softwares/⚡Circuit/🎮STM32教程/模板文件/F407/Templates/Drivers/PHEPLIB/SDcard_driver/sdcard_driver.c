...
// static SDIO_CmdInitTypeDef     sd_cmd_InitStructure;
// static SDIO_DataInitTypeDef    sd_data_InitStructure;
...
SDCard_Err SDCard_initFS(void){
    ...
    if (f_mount(&fs, SDCARD_ROOTDIRECTORY, 1) == FR_OK){
        return NOERR;
    }
